...
export default function Business() {
  return (
    <>
      <div className="w-full min-h-screen flex bussiness" id="business">
      ...
      <div>
        ...
        <div className="videos flex w-full min-h-screen justify-evenly items-center gap-4 p-4 flex-wrap">
          <iframe
            className="rounded-xl"
            width="560"
            height="315"
            src="https://www.youtube.com/embed/XMG0oLUDlE8"
          ...
          <iframe
            ...
            width="560"
            height="315"
            src="https://www.youtube.com/embed/chjJXKZmXrc"
            title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen
          ...
          <iframe
            ...
            width="560"
            height="315"
            src="https://www.youtube.com/embed/xJGR6e0DzIw"
            title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen
          ...
          <iframe
            ...
            width="560"
            height="315"
            src="https://www.youtube.com/embed/zrrFl412ccA"
            title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen
